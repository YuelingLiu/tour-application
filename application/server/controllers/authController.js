...
exports.login = catchAsync(async (req, res, next) => {
  // read password and email from body
  // const email = req.body.email; // we shall use es6 discontructing
  // or
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (
    ...
    console.log('what is token here after req.cookies.jwe', req.cookies.jwt);
  }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  // 1) Get user nased on the Posted email
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  console.log('checking before createsentoken in resetpassword');
