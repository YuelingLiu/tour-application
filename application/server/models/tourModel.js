...
// simple shema for tours
const tourSchema = new mongoose.Schema(
  {
    // required the second arg is error
    name: {
      type: String,
      unique: true,
    ...
    ratingsAverage: {
      ...
      set: (val) => Math.round(val * 10) / 10, //4.66666 * 10= 46.6666 / 10 = 4.7
    },
...
// then later we can use this Tour

// where we do need these tools
// in controller
module.exports = Tour;
